...
Revision ID: d910a8aaa83c
Revises: 
Create Date: 2024-07-11 18:38:16.516074
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('langueId', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('cover_player', sa.String(length=300), nullable=False),
    sa.Column('cover_image', sa.String(length=300), nullable=True),
    sa.Column('seo_title', sa.String(length=200), nullable=False),
    sa.Column('seo_description', sa.String(length=300), nullable=False),
    ...
    sa.Column('movie_type', sa.String(length=5), nullable=False),
    sa.Column('zip_file', sa.String(length=200), nullable=False),
    sa.Column('rate', sa.Float(), nullable=True),
    sa.Column('views', sa.Integer(), nullable=True),
    sa.Column('is_active', sa.String(length=7), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
